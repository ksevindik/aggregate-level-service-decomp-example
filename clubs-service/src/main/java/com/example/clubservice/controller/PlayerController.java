...
import com.example.clubservice.migration.ReadWriteApiDispatcher;
...
public class PlayerController {
    ...
    public ResponseEntity<Player> createPlayer(@RequestBody Player player) {
        return new ResponseEntity<>(readWriteApiDispatcher.createPlayer(player), HttpStatus.CREATED);
    }
