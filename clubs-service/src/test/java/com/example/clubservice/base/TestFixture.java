...
public class TestFixture {
    ...
    public TestFixture(ClubRepository clubRepository, PlayerRepository playerRepository, IdMappingRepository idMappingRepository) {
    ...
    private void createIdMappings(IdMapping... idMappings) {
